...
(function (blink) {
	...
	companeros2021_demoStyle.prototype = {
		...
		formatCarouselindicators: function () {
			...
			$navbarBottom
				.attr('class', 'companeros2021_demo-navbar')
		...
		animateNavbarOnScroll: function () {
			...
			var $navbar = $('.companeros2021_demo-navbar');
			var lastScrollTop = 0;
        ...
        changeHighBar: function () {
            if($('.companeros2021_demo-navbar').length>0 && $('.navbar').length>0){
                blink.theme.setTopByHeight('.navbar', '.companeros2021_demo-navbar');
            }
        }
	};
